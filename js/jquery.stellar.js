! function(t, e, i, s) {
        ...
        r = {
            ...
            transform: {
                setPosition: function(t, e, i, s, o) {
                    t[0].style[a] = "translate3d(" + (e - i) + "px, " + (s - o) + "px, 0)"
                }
            }
        },
        a = function() {
    ...
    function Plugin(e, i) {
        this.element = e, this.options = t.extend({}, o, i), this._defaults = o, this._name = "stellar", this.init()
    }
    Plugin.prototype = {
        init: function() {
            this.options.name = "stellar_" + Math.floor(1e9 * Math.random()), this._defineElements(), this._defineGetters(), this._defineSetters(), this._handleWindowLoadAndResize(), this._detectViewport(), this.refresh({
                firstLoad: !0
        ...
        _findBackgrounds: function() {
            ...
            this.backgrounds = [], this.options.parallaxBackgrounds && (e = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (e = e.add(this.$element)), e.each((function() {
                ...
                d.data("stellar-backgroundStartingLeft") ? f(d, d.data("stellar-backgroundStartingLeft"), d.data("stellar-backgroundStartingTop")) : (d.data("stellar-backgroundStartingLeft", u[0]), d.data("stellar-backgroundStartingTop", u[1])), r = "auto" === d.css("margin-left") ? 0 : parseInt(d.css("margin-left"), 10), a = "auto" === d.css("margin-top") ? 0 : parseInt(d.css("margin-top"), 10), l = d.offset().left - r - s, h = d.offset().top - a - o, d.parents().each((function() {
                    var e = t(this);
        ...
        _reset: function() {
            ...
            for (o = this.backgrounds.length - 1; o >= 0; o--)(s = this.backgrounds[o]).$element.data("stellar-backgroundStartingLeft", null).data("stellar-backgroundStartingTop", null), f(s.$element, s.startingValueLeft, s.startingValueTop)
        },
        destroy: function() {
        ...
        return void 0 === e || "object" == typeof e ? this.each((function() {
            ...
            s instanceof Plugin && "function" == typeof s[e] && s[e].apply(s, Array.prototype.slice.call(i, 1)), "destroy" === e && t.data(this, "plugin_stellar", null)
        })) : void 0
    }, t.stellar = function(i) {
        var s = t(e);
        return s.stellar.apply(s, Array.prototype.slice.call(arguments, 0))
    }, t.stellar.scrollProperty = n, t.stellar.positionProperty = r, e.Stellar = Plugin
